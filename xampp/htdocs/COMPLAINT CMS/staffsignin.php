...
<div class="login-page">
    <div class="login-main">
        ...
        <?php
          ...
          ?>
				<form role="form" action="checkstaff.php" method="POST">
					<input type="text" name="emailLogin" placeholder="Username" required="">
					<input type="password" name="passwordLogin" class="lock" placeholder="Password">
          ...
          <!-- <h3>Staff Member?<a href='staffsignin.php'>Staff signin from here</a></h3> -->
